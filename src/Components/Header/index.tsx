...
const Header = () => {
  ...
  const { wrapperDropdownNotify } = useDropNotify();
    ...
    <C.Container>
      ...
      <C.AreaNavigate>
        <C.LeftArea>
          ...
          {/** Error com o botão de mais informações... */}
          <C.MailIcon />
          {/* <C.CheckIcon />
          <C.ChatIcon />
          <C.CalendarIcon /> */}
        ...
        <C.RightArea>
          <C.AreaNotify countTitles={titles.length}>
            <C.BellIcon onClick={wrapperDropdownNotify} />
          </C.AreaNotify>
          <C.DropdownNotifyArea>
            <DropdownNotify />
          </C.DropdownNotifyArea>
